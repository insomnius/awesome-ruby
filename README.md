...
* [Rubicons](https://github.com/insomnius/rubicons) - Ruby and Rails SVG icon toolkit inspired by React Icons with 20+ icon pack from Lucide, Font Awesome and more.
